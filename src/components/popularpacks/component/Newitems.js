...
function Newitems  () {
    const newcardData = [
        {
         ...
         heading : "Perry Ice cream Banana",
         weight: "800gm",
         offer: "$13",
         rate : "$15"
        ...
        },
         {
          ...
          heading: "Vennila Ice Cream Banana",
          weight: "500gm",
          offer: "$12",
          rate : "$15"
  ...
  return (
    <div>
        ...
        <div className="carousel-item w-52 border-2 border-solid rounded-lg">
            ...
            <div className="card w-96 bg-base-100 shadow-xl ml-2" key={data} onClick={()=> navigate("/newpacks")}>
         <figure className="px-12 mt-2">
           <img src={card.img} alt="Shoes" className="rounded-xl mt-2" />
      </figure>
   <div className="card-body items-center text-center">
       <h2 class="card-title font-medium text-xl">{card.heading}</h2>
  ...
  { newdesertdata.map((card,data) => (
            <div className="card w-96 bg-base-100 pt-2 border-2 border-solid rounded-lg" key={data}  onClick={()=> navigate("/newpacks")}>
  ...
  <div className="card-body items-center text-center">
    <h2 className="card-title font-semibold text-2xl ">{card.heading}</h2>
    <p class ='font-normal'>{card.weight}</p>
    <div className="card-actions">
    <p className=' text-lg font-medium'>{card.offer}</p>
        <p class="font-normal line-through">{card.rate}</p>
